...
namespace XRLibrary
{
    public class LoadData : MonoBehaviour
    {
        ...
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(String.Format("https://api.xrcommunity.org/v1/xap/organs/getListLessonByOrgan?organId=&searchValue={0}&offset={1}&limit={2}", searchValue, offset, limit)); 
            request.Method = "GET";
