...
namespace ListOrgan 
{
    public class LoadData : MonoBehaviour
    {
        ...
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(String.Format("https://api.xrcommunity.org/v1/xap/organs/getListLessonByOrgan?organId={0}&searchValue={1}&offset={2}&limit={3}", organId, searchValue, offset, limit)); 
            request.Method = "GET";
